...
def init_db():
    ...
    # Tabelle zum Speichern der Elo-Historie pro Spiel
    cursor.execute("""
    ...
    # NEU: Tabelle zum Speichern der Edit-Historie von Spielen
    cursor.execute("""
    CREATE TABLE IF NOT EXISTS games_history (
        history_id INTEGER PRIMARY KEY AUTOINCREMENT,
        game_id INTEGER NOT NULL,
        changed_at DATETIME NOT NULL,
        old_red_score INTEGER NOT NULL,
        new_red_score INTEGER NOT NULL,
        old_blue_score INTEGER NOT NULL,
        new_blue_score INTEGER NOT NULL,
        FOREIGN KEY (game_id) REFERENCES games(id) ON DELETE CASCADE
    );
    """)
